...
KeyboardStyle {
    ...
    readonly property string resourcePrefix: "qrc:data/QtQuick/VirtualKeyboard/Styles/light/"

    readonly property string inputLocale: InputContext.locale
    property color inputLocaleIndicatorColor: "#3D3D3D"
    property Timer inputLocaleIndicatorHighlightTimer: Timer {
        interval: 1000
        onTriggered: inputLocaleIndicatorColor = "#333333"
    }
    onInputLocaleChanged: {
        inputLocaleIndicatorColor = "black"
